...
public class DiscussionGroupTest {
	...
	public void testAddDiscussionGroups() {
		...
		assertEquals("Test that adding an item with empty name does not change the ArrayList size.",
				newSizeAfterAddingMissing, discussionList.size());
	}
	...
	public void testDeleteDiscussionGroups() {
		...
		DiscussionGroupsMain.deleteDiscussionGroups(discussionList, topicToDelete);
		...
		DiscussionGroupsMain.deleteDiscussionGroups(discussionList, nonExistingTopic);
